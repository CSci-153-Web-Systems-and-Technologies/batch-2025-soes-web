      ...
      <Table>
        <TableHeader>
          <TableRow className="border-b border-gray-100 hover:bg-transparent">
            <TableHead className="w-[300px] font-medium text-gray-900">Template Name</TableHead>
            <TableHead className="font-medium text-gray-900">Category</TableHead>
            <TableHead className="font-medium text-gray-900">Positions</TableHead>
            ...
            <TableHead className="text-right font-medium text-gray-900">Act</TableHead>
          </TableRow>
        </TableHeader>
        <TableBody>
          {data.length === 0 ? (
            ...
            data.map((template) => (
              <TableRow key={template.id} className="border-b border-gray-50 hover:bg-gray-50/50">
                ...
                <TableCell>
                  <Badge 
                    variant="outline" 
                    className={`rounded-md font-medium px-2.5 py-0.5 ${getCategoryStyle(template.category)}`}
                  >
                ...
                <TableCell>
                  <span className="text-sm font-medium text-gray-900">
                    {template.usage_count || 0} elections
                  </span>
                </TableCell>
